...
<asp:Content ID="contentConnexion" ContentPlaceHolderID="content" runat="server">
    <div id="loginBox">
        ...
        <asp:CustomValidator runat="server" ID="validateEmailPasswordBanned" OnServerValidate="validateEmailPasswordBanned_ServerValidate" ErrorMessage="Le nom d'utilisateur ou mot de passe est invalide, ou le compte a été banni."></asp:CustomValidator><br />
